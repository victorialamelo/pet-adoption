              ...
              <div className="signup card p-4">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-3">
                    ...
                    {nameError && <p className="error-message">{nameErrorMessage}</p>}
                  </div>
                  ...
                  <div className="mb-3">
                    <label className="form-label">Are you adopting or posting a pet?</label>
                    <div className="form-check">
                      ...
                      />
                      <label htmlFor="adopting" className="form-check-label">Adopting</label>
                    </div>
                    <div className="form-check">
                      <input
                        type="radio"
                        ...
                        onChange={handleRoleChange}
                      />
                      <label htmlFor="posting" className="form-check-label">Posting a pet</label>
                    </div>
                  </div>
                ...
                <hr />
                <p className="text-center">Already have an account? <a href="/Login" className="text-decoration-none">Log in</a></p>
              </div>
            </div>
          </div>
        </div>
